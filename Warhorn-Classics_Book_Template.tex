...
\begin{center}\includegraphics[width=0.5\linewidth]{/home/travis/build/warhornmedia/warhorn-classics-book-template/classics-template-files/images/whitelogo} \end{center}
...
\hypertarget{some-quick-reminders}{%
\chapter{Some quick reminders}\label{some-quick-reminders}}
...
\tightlist
\item
  Add the project on travis-ci.com (You may have to log out and back in for the project to show up.)
\end{enumerate}
