...
This will encrypt your token so that only Travis can use it, and only on this repo. Then you don't need to worry about that encrypted data showing up in our public repo in the .travis.yml file.
